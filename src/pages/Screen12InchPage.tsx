            ...
            <div className="border border-gray-200 rounded-lg">
              ...
              {expandedSection === 'emc' && (
                <div className="overflow-hidden transition-all duration-500 ease-in-out">
                  <div className="px-6 py-4 bg-white">
                    <div className="space-y-3 text-gray-700">
                      <p>Military-grade electromagnetic compatibility for harsh environments</p>
                      <p>EN 50121-3-2 (Railway applications - EMC) - Enhanced level</p>
                      <p>IEC 61000-4-2 (Electrostatic discharge immunity) - Level 4</p>
                      <p>IEC 61000-4-3 (Radiated electromagnetic field immunity) - Level 4</p>
                      <p>IEC 61000-4-4 (Electrical fast transient immunity) - Level 4</p>
                      <p>IEC 61000-4-5 (Surge immunity) - Level 4</p>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="overflow-hidden transition-all duration-500 ease-in-out">
                  <div className="px-6 py-4 bg-white">
                    <div className="space-y-3 text-gray-700">
                      ...
                      <p>IEC 61508 (Functional Safety)</p>
                      <p>DO-160 (Aircraft environmental conditions)</p>
                    </div>
                  </div>
                </div>
              )}
